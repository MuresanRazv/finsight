...
class WSJScraper(NewsScraper):
    """
    Scraper for the Wall Street Journal 'Markets' RSS feed.
    """
    ...
    def scrape(self) -> List[FinancialNewsItem]:
        """
        Scrapes the WSJ RSS feed for news articles.
        ...
        try:
            ...
            for item in items:
                ...
                try:
                    ...
                    # WSJ uses "Mon, 29 May 2024 10:00:01 GMT"
                    if pub_date_str:
