...
class FinancialTimesScraper(NewsScraper):
    """
    Scraper for the Financial Times 'Companies' RSS feed.
    """
    ...
    def scrape(self) -> List[FinancialNewsItem]:
        """
        Scrapes the Financial Times RSS feed for news articles.
        ...
        try:
            ...
            for item in items:
                ...
                try:
                    # FT uses standard RFC 822 format: "Wed, 29 May 2024 10:00:01 GMT"
                    if pub_date_str:
